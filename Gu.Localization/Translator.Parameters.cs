namespace Gu.Localization
{
    ...
    public static partial class Translator
    {
        ...
        public static string Translate<T>(ResourceManager resourceManager, string key, CultureInfo culture, T arg0, ErrorHandling errorHandling = ErrorHandling.Inherit)
        {
            string format;
        ...
        /// <param name="errorHandling">Specifies how to handle errors.</param>
        /// <returns>The key translated to the <paramref name="culture"/></returns>
        public static string Translate<T0, T1>(ResourceManager resourceManager, string key, CultureInfo culture, T0 arg0, T1 arg1, ErrorHandling errorHandling = ErrorHandling.Inherit)
        {
            string format;
            if (!TryTranslateOrThrow(resourceManager, key, culture, errorHandling, out format))
            {
