namespace Gu.Localization.Analyzers.Tests.GULOC07KeyDoesNotMatchrTests
{
    ...
    internal class CodeFix
    {
        ...
        public void SetUp()
        {
            ...
            this.resourcesFile = tempDir.FindFile("Resources.cs");
            this.resxFile = tempDir.FindFile("Properties\\Resources.resx");
        }

        [Test]
        public void OnlyDefaultResx()
        {
            this.resxFile.ReplaceText("One_resource", "Wrong");
            this.resourcesFile.ReplaceText("public static string One_resource", "public static string Wrong");
...
namespace RoslynSandbox.Properties {
    ...
    public class Resources {
        ...
        /// </summary>
        public static string One_resource {
            get {
            ...
            CodeAssert.AreEqual(expected, fixedSln.FindDocument("Resources.cs"));
