namespace Gu.Wpf.Localization
{
    ...
    public class LanguageSelector : Control, IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether languages should be autogenerated. If true <see cref="Languages"/> are kept in sync with <see cref="Translator.AllCultures"/>
